 ...
 * @date 下午2:58 18-7-24
 */
public class getSysInfoBySugar {
     ...
     * @Description 输出系统属性(jvm获取)
     */
    private static void getPropertyInfo() throws UnknownHostException {
     ...
     * @Description 输出用户信息
     */
    private static void getUserInfo() throws SigarException {
        ...
        for (int i = 0; i < fslist.length; i++) {
            ...
            switch (fs.getType()) {
                ...
                case 2: // TYPE_LOCAL_DISK : 本地硬盘
                    ...
                    // 文件系统资源的利用率
                    System.out.println(fs.getDevName() + "资源的利用率:    " + usage.getUsePercent() * 100D + "%");
                    break;
